...
figure;
plot(cas_najlepsie, odozva_najlepsie);
hold on;
...
if ~isempty(indexy_max_najlepsie)
    plot(cas_najlepsie(indexy_max_najlepsie(1)), odozva_najlepsie(indexy_max_najlepsie(1)), 'ro', 'MarkerSize', 8, 'DisplayName', 'y1 (Prvé maximum)');
end
if ~isempty(indexy_min_najlepsie)
    plot(cas_najlepsie(indexy_min_najlepsie(1)), odozva_najlepsie(indexy_min_najlepsie(1)), 'go', 'MarkerSize', 8, 'DisplayName', 'y2 (Prvé minimum)');
end
plot(cas_najlepsie(1), odozva_najlepsie(1), 'bo', 'MarkerSize', 8, 'DisplayName', 'y0 (Počiatočná hodnota)');
