...
% Vytvorenie grafu
p = plot(vymoly, cas_regulacie_vsetky);
...
xlabel_handle = xlabel('V\''{y}mol [$m$]', 'Interpreter', 'latex');
...
title_handle = title('\v{C}as regul\''{a}cie pre jednotliv\''{e} v\''{y}moly', 'Interpreter', 'latex');
